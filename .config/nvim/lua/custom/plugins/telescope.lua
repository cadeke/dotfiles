return { -- Fuzzy Finder (files, lsp, etc)
  ...
  config = function()
    ...
    vim.keymap.set('n', '<leader>ft', builtin.builtin, { desc = '[F]ind in select [T]elescope' })
    vim.keymap.set('n', '<leader>fw', builtin.grep_string, { desc = '[F]ind current [W]ord' })
    vim.keymap.set('n', '<leader>fg', builtin.live_grep, { desc = '[F]ind by [G]rep' })
    vim.keymap.set('n', '<leader>fd', builtin.diagnostics, { desc = '[F]ind in [D]iagnostics' })
    vim.keymap.set('n', '<leader>fc', builtin.resume, { desc = '[F]ind process [C]ontinue' })
    vim.keymap.set('n', '<leader>fr', builtin.oldfiles, { desc = '[F]ind in [R]ecent Files' })
